...
const flowNewCar = addKeyword<Provider, Database>(['car'])
    ...
    .addAnswer('¿Cuál es el número de serie del coche? (Puede encontrarlo en el parabrisas o en la tarjeta de circulación)', { capture: true, media: join(process.cwd(), 'assets', 'vin.jpg') }, async (ctx, { state, fallBack, flowDynamic }) => {
